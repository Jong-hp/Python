...
# img1 = cv2.imread('./sajin.jpg', cv2.IMREAD_COLOR)  # 컬러 # 채널(channel) : 3 (R,G,B)
# img1 = cv2.imread('./sajin.jpg', cv2.IMREAD_GRAYSCALE)    # 흑백 # 채널(channel) : 1
img1 = cv2.imread('./sajin.jpg', cv2.IMREAD_REDUCED_COLOR_2) # 크기 변경
